...
public class Calculator {
    // 主框架
    public JFrame jframe = new JFrame("Calculator by Group 22");
    //显示窗口载体
    public JPanel jpanel_show = new JPanel();
    // 输入显示标签
    public JLabel jla_input = new JLabel();
    // 结果显示标签
    public JLabel jla_show = new JLabel();
    // 错误信息显示标签
    public JLabel jla_error = new JLabel();
    // 计算器按键载体
    public JPanel jp_button = new JPanel();
    public String result = " ";
    // 按键显示字符
    public String[] str = { "1", "2", "3", "+", "x²","x³", "4", "5", "6", "-", "Abs","cos", "7", "8", "9", "*", "1/x","tan", "0", "(",
            ")", "÷", "log","sin",".","←", "c", "=", "Int","√"};
    // 按键
    public JButton[] jb_button = new JButton[str.length];
    ...
    public static String parseInputStr(String result, String content) {
        ...
        // 以数字结尾
            ...
            if (lastNumberOfStr(result).matches("^0+")
                ...
                result = result + "";
            // 数字后面跟x²，1/x，√
            else if (content.matches("x²|x³|1/x|√|log|sin|cos|Abs|Int|tan")) {
        ...
        // 以右括号结尾
            ...
            if (content.matches("x²|x³|1/x|√|log|sin|cos|Abs|Int|tan")) {
